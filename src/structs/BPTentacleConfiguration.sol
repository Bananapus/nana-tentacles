...
/// @custom:member mintRequiresNativeAssetPayment If the tentacle requires a payment to be created. (ex. to pay for message bridging)
...
struct BPTentacleConfiguration {
    ...
    bool mintRequiresNativeAssetPayment;
